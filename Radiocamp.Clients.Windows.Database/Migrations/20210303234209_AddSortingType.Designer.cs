...
namespace Dartware.Radiocamp.Clients.Windows.Database.Migrations
{
    ...
    [Migration("20210303234209_AddSortingType")]
    partial class AddSortingType
    {
            ...
            modelBuilder.Entity("Dartware.Radiocamp.Clients.Windows.Hotkeys.Hotkey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab664de2-c31d-4542-a1db-066b773cfaf8"),
                            Command = 1,
                            IsEnabled = false,
                            Key = 0,
                            ModifierKey = 0
                        ...
                        new
                        {
                            Id = new Guid("c2cd9df7-f9ea-4255-ade9-3d8b74ceb1cb"),
                            Command = 2,
                            IsEnabled = false,
                            Key = 0,
                            ModifierKey = 0
                        ...
                        new
                        {
                            Id = new Guid("f20e7c06-7a49-4c39-a049-0a03fb171362"),
                            Command = 3,
                            IsEnabled = false,
                            Key = 0,
                            ModifierKey = 0
                        ...
                        new
                        {
                            Id = new Guid("4ee052bf-8c12-46ea-86ae-c1ba7d20c1f5"),
                            Command = 4,
                            IsEnabled = false,
                            Key = 0,
                            ModifierKey = 0
                        ...
                        new
                        {
                            Id = new Guid("f1d0853d-5a1f-4324-95dd-29ff60d974b5"),
                            Command = 5,
                            IsEnabled = false,
                            Key = 0,
                            ModifierKey = 0
                        ...
                        new
                        {
                            Id = new Guid("47873c75-5ab8-4221-92e9-529a1869f4a2"),
                            Command = 6,
                            IsEnabled = false,
                            Key = 0,
                            ModifierKey = 0
            ...
            modelBuilder.Entity("Dartware.Radiocamp.Clients.Windows.Settings.Settings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("479197f1-57b2-465f-a338-ebb420da68ba"),
